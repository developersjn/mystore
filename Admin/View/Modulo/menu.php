...
$dia = date("d", $fechaSegundos);
$mes = date("m", $fechaSegundos);
    ...
    <div class="header-content">
                ...
                <ul class="navbar-nav header-right main-notification">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            <img src="<?php echo RutaController::getRutaRecursos(); ?>images/profile/pic1.jpg" width="20" alt="">
        ...
        <div class="sub-header">
            ...
            <div class="d-flex align-items-center">
                <a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1"><?php echo $dia; ?></a>
                <a href="javascript:void(0);" class="btn btn-xs btn-primary light mr-1"><?php echo $mes; ?></a>
                <a href="javascript:void(0);" class="btn btn-xs btn-primary light"><?php echo $año; ?></a>
            </div>
        </div>
    </div>
</div>
...
<div class="deznav">
    <div class="deznav-scroll">
        <div class="main-profile">
            <div class="image-bx">
                <img src="<?php echo RutaController::getRutaRecursos(); ?>images/Untitled-1.jpg" alt="">
                    <a href="javascript:void(0);"><i class="fa fa-cog" aria-hidden="true"></i></a>
            </div>
            <h5 class="name"><span class="font-w400">Enrique,</span> Acosta</h5>

        </div>
        <ul class="metismenu" id="menu">
            <li><a class="has-arrow ai-icon"  target="_blank" href="http://localhost:90/netbeansproyect/TiendaDrywall/">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="#" onclick="AbrirUrl('View/Producto/FindAll.php', 'contenedor-main')">Productos</a></li>
                    <li><a href="#" onclick="AbrirUrl('View/Producto/Create.php', 'contenedor-main')">Nuevo Producto</a></li>
                    <li><a href="#" onclick="AbrirUrl('View/Producto/Reporte.php', 'contenedor-main')">Reporte Producto</a></li>
                    <li><a href="#" onclick="AbrirUrl('View/Producto/Proveedor.php', 'contenedor-main')">Proveedores</a></li>                    
                    <li><a href="#" onclick="AbrirUrl('View/Producto/Inventario.php', 'contenedor-main')">Inventario</a></li>
                    <li><a href="#" onclick="AbrirUrl('View/Producto/Categoria.php', 'contenedor-main')">Categoria</a></li>
                </ul>

            </li>
            <li class="nav-label">Usuario</li>
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                    <i class="flaticon-077-menu-1"></i>
                    <span class="nav-text">Usuario</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="#" onclick="AbrirUrl('View/Usuario/Create.php', 'contenedor-main')">Registrar</a></li>
                    <li><a href="perfil-usuario">Perfil</a></li>
                    <li><a href="detalle-usuario">Detalles<span class="badge badge-xs badge-danger">New</span></a></li>
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Portafolio<span class="badge badge-xs badge-danger">New</span></a>
                        <ul aria-expanded="false">
                            <li><a href="php-proyectos">PHP Proyectos</a></li>
                            <li><a href="java-proyectos">JAVA Proyectos</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Error</a>
                        <ul aria-expanded="false">
                            <li><a href="error-404">Error 400</a></li>
        ...
        <div class="copyright">
            <p><strong>MasterCode Admin Dashboard</strong> © 2023 All Rights Reserved</p>
            <p class="fs-12">Made with <span class="heart"></span> by MasterCode</p>
        </div>
    </div>
</div>
<!--*Sidebar end*-->
